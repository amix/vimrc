基本的 vim 操作就不介绍了，看过一本简明手册：
https://github.com/Tiande/Practice/blob/master/resource/VIM_Tutorial.html
...
# emmet (zencoding)
see the tutorial in 
"./sources_forked/emmet-vim/TUTORIAL" # 你可以用 gf 直接打开链接哦！
...
# 这三个打开命令随便哪个都行， <c-f> <c-b> 可以多按几次看不同效果，其他看帮助
1.  <c-f>
2.  <c-b>
